...
class FetchData:
    ...
    def __init__(
        self, latitude, longitude, startdate, enddate, hourlyParameters, dailyParameters
    ):
        self.lat = latitude
        self.long = longitude
...
hourlyParameters = ["temperature_2m", "wind_speed_10m"]

fd = FetchData(39.50, 32.5, "2009-01-01", "2024-02-12", hourlyParameters, dailyParameters )
